...
public class RectDrawable extends Drawable {
	...
	public static RectDrawable fromBitmap(Bitmap bitmap) {
		if (bitmap != null) {
			return new RectDrawable(bitmap);
		} else {
			return null;
		}
	}
	...
	public RectDrawable setCornerRadius(float radius) {
	...
	/** 设置边框宽度 */
	public RectDrawable setBorderWidth(int width) {
		mBorderWidth = width;
		mBorderPaint.setStrokeWidth(mBorderWidth);
		return this;
	}
	...
	/** 设置边框颜色 */
	public RectDrawable setBorderColor(int color) {
	...
	public RectDrawable setBorderColors(ColorStateList colors) {
	...
	public RectDrawable setOval(boolean oval) {
		mOval = oval;
		return this;
	}
	...
	public RectDrawable setScaleType(ScaleType scaleType) {
		if (scaleType == null) {

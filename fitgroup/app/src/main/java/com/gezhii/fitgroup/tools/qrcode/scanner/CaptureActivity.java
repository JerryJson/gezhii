package com.gezhii.fitgroup.tools.qrcode.scanner;
...
import com.gezhii.fitgroup.tools.qrcode.scanner.camera.CameraManager;
import com.gezhii.fitgroup.tools.qrcode.scanner.decode.CaptureActivityHandler;
import com.gezhii.fitgroup.tools.qrcode.scanner.view.ViewfinderView;
import com.gezhii.fitgroup.ui.activity.BaseActivity;
...
//        lastResult = rawResult;
        ...
        if (!isDialogShowing) {
            ...
            String code = ResultParser.parseResult(rawResult).toString();
            EventBus.getDefault().post(new ScannerQRCodeResultEvent(code));
            finish();
        }
    }

...
package com.gezhii.fitgroup.tools.qrcode.scanner.camera;
...
import com.gezhii.fitgroup.tools.qrcode.scanner.config.Config;
...
final class AutoFocusManager implements Camera.AutoFocusCallback {
    ...
    public synchronized void onAutoFocus(boolean success, Camera theCamera) {
        if (active) {
            ...
            com.gezhii.fitgroup.tools.qrcode.scanner.common.Runnable.execAsync(outstandingTask);
        }
    }
